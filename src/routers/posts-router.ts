...
postsRouter.post('/', authMiddleware, postValidation, errorsValidationMiddleware, postPostController);

postsRouter.get('/:postId', findPostController);

postsRouter.put('/:postId', authMiddleware, postValidation, errorsValidationMiddleware, updatePostController);
